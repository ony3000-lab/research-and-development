...
function LoginForm() {
  const { formProps, errors, onSubmit } = useLoginForm();
...
export default function CustomHookPatternLogin() {
  return (
    <>
      <PageHead title="Login Form (Custom Hook Pattern)" />
      <main className="prose mx-auto min-h-screen p-8 dark:prose-invert">
        <h1>Login Form (Custom Hook Pattern)</h1>
